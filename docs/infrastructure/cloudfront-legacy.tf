...
# the dangling CNAME (via IONIX external access attempt surface scan, Shodan, or DNS
...
#
# .ts: Access-Control-Allow-Origin: *.techstride.io),
...
# The access attempt surface is a decommissioned infrastructure artifact.
#
